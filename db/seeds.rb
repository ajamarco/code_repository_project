...
Post.create(title: "string", description: "text", content: "text", likes: 2, language_id: 2, user_id: 4)
Post.create(title: "string", description: "text", content: "text", likes: 3, language_id: 1, user_id: 3)
Post.create(title: "string", description: "text", content: "text", likes: 2, language_id: 3, user_id: 1)
Post.create(title: "string", description: "text", content: "text", likes: 4, language_id: 1, user_id: 2)
Post.create(title: "string", description: "text", content: "text", likes: 9, language_id: 2, user_id: 1)
Post.create(title: "string", description: "text", content: "text", likes: 2, language_id: 1, user_id: 4)
